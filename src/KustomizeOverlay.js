              ...
              <div className="flex flex1">
                <div className="flex-column flex1">
                  <div className="u-paddingLeft--20 u-paddingRight--20 u-paddingTop--20">
                    ...
                    <p className="u-fontSize--small u-lineHeight--more u-paddingBottom--20 u-fontWeight--medium u-color--doveGray">This is the original YAML that you uploaded. Click on any attribute(s) below and this tutorial will 1) prepare the necessary kustomization.yaml and 2) calculate the patch YAML for you to edit with your desired value</p>
                  </div>
